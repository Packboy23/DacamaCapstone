...
<body>
    ...
    if (isset($_GET['id'])) {
        ...
        if ($resultEdit->num_rows > 0) {
            ...
            echo "<form action='update_elec.php' method='post'><img src='images/edit_blue.png' style='height:30px; width: 30px; position: absolute; margin-top: 5px'>
                ...
                <div style='margin-left: 60px; margin-top: 6px; font-weight: bold'>First Exam Score:&nbsp&nbsp <input type='text' style='width: 30px; position: absolute' name='elec' value='" . $rowEdit['elec'] . "'></div><br>

                <div style='margin-left: 60px; margin-top: 6px; font-weight: bold'>Second Exam Score:&nbsp&nbsp <input type='text' style='width: 30px; position: absolute' name='elec2' value='" . $rowEdit['elec2'] . "'></div><br>
