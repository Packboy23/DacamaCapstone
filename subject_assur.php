...
<body>
<br>
<h2 style="margin-top: -8px; margin-left: 110px;padding: 15px; height: 50px;  font-size: 18px; color: #34425A; border-radius: 2px; border-color: white; border-width: 1px;  position: absolute; background-color: #f6f6f6; border-style: outset">INFORMATION ASSURANCE 1</h2>
<button onclick="openModal()" style="padding: 15px; height: 50px; margin-left: 600px; font-size: 18px; color: blue; border-radius: 2px; border-color: white; border-width: 1px; margin-top: -10px; position: relative; cursor: pointer"><b>Add Student</b></button>
    ...
    <div id="myModal" class="modal" style="margin-left: 30px; margin-top: 60px;">
        <div class="modal-content">
            ...
            <form action="add_assur.php" method="post">
               <div style="margin-left: -100px"> <label for="fullname"><b>Name:</b></label>
                ...
                <div style="margin-top: 10px; margin-left: -132px">
                    <label for="assur"><b>First Exam Score:</b></label>
                    <input type="text" name="assur" style="width: 80px" required>
                </div>

                <div style="margin-top: 10px; margin-left: -112px">
                    <label for="assur2"><b>Second Exam Score:</b></label>
                    <input type="text" name="assur2" style="width: 80px" required>
                </div>

             <input type="hidden" value ="3" name ="year">
    ...
    <div style="margin-top: -10px; margin-left: 40px; position: ">
            ...
            if (isset($_SESSION['user_id'])) {
                ...
                $sql = "SELECT * FROM tbl_users WHERE assur and assur2 IS NOT NULL AND year IN (3)  ORDER BY fullname ASC";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr><td style='color: #34425A'>"
                            ...
                            . $row["assur"] . "%&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                            &nbsp<td style='color: black'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"    
                            . $row["assur2"] . "%&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                            
                            
                            <td style='width: 70px'><a href='edit_assur.php?id=" . $row['user_id'] . "'><center><img src='images/edit_icon.PNG' style='height: 20px; width: 20px'></center></a></td>
                            <td style='width: 90px'><a href='delete_assur.php?id=" . $row['user_id'] . "'><center><img src='images/delete_icon.PNG' style='height: 20px; width: 20px'></center></a></td>
