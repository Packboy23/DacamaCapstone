...
<body>
<br>
<h2 style="margin-top: -8px; margin-left: 110px;padding: 15px; height: 50px;  font-size: 18px; color: #34425A; border-radius: 2px; border-color: white; border-width: 1px;  position: absolute; background-color: #f6f6f6; border-style: outset">CCE 102</h2>
            ...
            <form action="add_cce102.php" method="post">
               <div style="margin-left: -100px"> <label for="fullname"><b>Name:</b></label>
                ...
                <div style="margin-top: 10px; margin-left: -132px">
                    <label for="cc102_1"><b>First Exam Score:</b></label>
                    <input type="text" name="cc102_1" style="width: 80px" required>
                </div>

                <div style="margin-top: 10px; margin-left: -112px">
                    <label for="cc102_2"><b>Second Exam Score:</b></label>
                    <input type="text" name="cc102_2" style="width: 80px" required>
                </div>
...
<div style="margin-top: -10px; margin-left: 40px; position: ">
            ...
            if (isset($_SESSION['user_id'])) {
                ...
                $sql = "SELECT * FROM tbl_users WHERE cc102_1 and cc102_2 IS NOT NULL AND year IN (1)  ORDER BY fullname ASC";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr><td style='color: #34425A'>"
                            ...
                            . $row["cc102_1"] . "%&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                            &nbsp<td style='color: black'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"    
                            . $row["cc102_2"] . "%&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                            
                            
                            <td style='width: 70px'><a href='edit_student2.php?id=" . $row['user_id'] . "'><center><img src='images/edit_icon.PNG' style='height: 20px; width: 20px'></center></a></td>
                            <td style='width: 90px'><a href='delete_student2.php?id=" . $row['user_id'] . "'><center><img src='images/delete_icon.PNG' style='height: 20px; width: 20px'></center></a></td>
