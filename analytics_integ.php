...
$query = "SELECT * FROM tbl_users WHERE integ and integ2 IS NOT NULL AND year IN (3)  ORDER BY fullname ASC";
...
<body>
    <h2 style="margin-top: 30px; margin-left: 135px;padding: 15px; height: 50px;  font-size: 18px; color: #34425A; border-radius: 2px; border-color: white; border-width: 1px;  position: absolute; background-color: #f6f6f6; border-style: outset">INTEGRATIVE PROGRAMMING</h2>
        ...
        var barChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: <?php echo json_encode(array_column($below75Score, 'integ')); ?>,
                    backgroundColor: 'rgba(75, 192, 192, 0.2)',
                    borderColor: 'rgba(75, 192, 192, 1)',
                    borderWidth: 1
                }, {
                    label: 'Second Exam Score ',
                    data: <?php echo json_encode(array_column($below75Score2, 'integ2')); ?>,
