...
<div class="page-content">
    <div class="card">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO tbl_yearly_two (user_id, fullname, score) VALUES ('$user_id', '$fullname', '$score')";

            if ($conn->query($sql) === TRUE) {

                $updateSql = "UPDATE tbl_yearly_two
                JOIN tbl_users ON tbl_yearly_two.user_id = tbl_users.user_id
                SET tbl_yearly_two.fullname = tbl_users.fullname";
