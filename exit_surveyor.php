<?php
include 'exit_survey_teacher.php';
?>
...
if ($result->num_rows > 0) {
    ...
    echo "<tr style='height: 50px'>
            <th style='width: 200px; background-color: black; color: white;width: 300px'>Fullname</th>
            <th style='width: 50px; background-color: black; color: white;'>Year</th>
            <th style='width: 100px; background-color: black; color: white;'>Course</th>
            <th style='background-color: black; color: white;'>Subject Name</th>
            <th style='background-color: black; color: white;'>Subject Code</th>
            <th style='background-color: black; color: white; width: 150px'>School Year</th>
            <th style='background-color: black; color: white; width: 100px'>Semester</th>
            <th style='background-color: black; color: white; width: 70px'>Term</th>
            <th style='background-color: black; color: white;'>Class Schedule</th>
            <th style='background-color: black; color: white;'>Room Number</th>
            <th style='background-color: black; color: white; width: 300px'>Is She/He good about this subject?</th>
            <th style='background-color: black; color: white;'>Does she/he like this subject?</th>
            <th style='background-color: black; color: white;'>Does she/he want to be assisted with this subject?</th>
          </tr>";
