...
<ul style="list-style-type: none;
  ...
  <li style="float: left; "><a class="active" href="news_student.php"><p style="color: #899DC1; font-weight: bold">News</p></a></li>
  <li style="float: left; "><a href="updates_student.php"><p style="color: #899DC1; font-weight: bold">Updates</p></a></li>
...
border-top: 1px solid #e3ecf5; border-bottom: 1px solid #e3ecf5; border-left: 1px solid #e3ecf5; border-right: 1px solid #e3ecf5; ">
              <small><p class="welcome" style="margin-left: -70px; text-shadow: 1px 1px 1px #000000; color: #1d7874; font-size: 20px"><br>"The art of teaching is the art of assisting Discovery"
-Mark Van Doren<br>
                 <br></p></small>
          </div>
  </div>
