...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['choice'])) {
        ...
        $sql = "INSERT INTO user_score3 (user_id, scores, timestamp, over_score) VALUES ('$user_id', '$scores', '$timestamp', '$over_score')";
        
        if ($conn->query($sql) === TRUE) {
            // Update the user_scores table with fullname from tbl_users
            $updateSql = "UPDATE user_score3
                          JOIN tbl_users ON user_score3.user_id = tbl_users.user_id
                          SET user_score3.fullname = tbl_users.fullname";
