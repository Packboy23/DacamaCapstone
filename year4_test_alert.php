...
// Check if the user is logged in and has a year column value of 4
...
if(isset($_SESSION['user_id'])) {
    ...
    if ($resultYear->num_rows > 0) {
        ...
        // Check if the user's year column value is 4
        if ($row['year'] == 4) {
            $c4 = true;
        } else {
            // Redirect or display an error message if the user's year is not 4
            $c4 = true;
            include 'yearly.php';
...
<form action="yearly4th.php" method="post">
