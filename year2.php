...
if (isset($_SESSION['user_id'])) {
    ...
    $sql = "SELECT * FROM tbl_users WHERE year = 2";
    ...
    if ($result->num_rows > 0) {
       ...
       <th style='background-color:   #34425A;color: white'>&nbsp&nbsp&nbsp Email&nbsp&nbsp&nbsp </th>
        <th style='background-color:   #34425A;color: white'>&nbsp&nbspContact&nbsp&nbsp Number&nbsp</th>
        <th style='background-color:   #34425A;color: white'> Address&nbsp&nbsp&nbsp&nbsp</th>
        <th style='background-color:   #34425A;color: white'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Birthday&nbsp&nbsp&nbsp&nbsp&nbsp </th>
        <th style='background-color:   #34425A;color: white'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Skills&nbsp&nbsp&nbsp&nbsp&nbsp </th>
       </tr>";
        ...
        while ($row = $result->fetch_assoc()) {
           ...
           . $row["email"] . "&nbsp&nbsp&nbsp&nbsp&nbsp</td><td style=';color: black'>&nbsp&nbsp&nbsp&nbsp&nbsp" 
            ...
            . $row["address"] . "&nbsp</td><td style='color: black'>&nbsp&nbsp&nbsp&nbsp&nbsp" 
            . $row["birthday"] . "&nbsp&nbsp</td><td style='color: black'>&nbsp&nbsp&nbsp&nbsp" 
            . $row["skills"] . "&nbsp&nbsp</td></tr>&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp";
