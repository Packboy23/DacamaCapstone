...
<body>
<br><br>
<h2 style="margin-left: 270px; ">Test Creator: Networking</h2>
...
<?php
    ...
    ?>
<form action="create_test3.php" method="post">
<br>
...
<ul>
    ...
    foreach ($tasks as $task) {
        echo "<br><br><br><br><br><br><li><hr><br>
            ...
            <a href='edit_test3.php?id={$task['id']}' style='width: 100px;  margin-top: -45px; margin-left: 660px; position: relative; border-style: solid; border-width:1px; border-radius: 6px; padding: 5px; width: 50px  '><img src='images/edit_icon.PNG' style='height: 20px; width: 20px'></a>
           
            <a href='delete_test3.php?id={$task['id']}' style='width: 100px; margin-top: -37px; margin-left: 720px; position: relative; border-style: solid; border-width:1px; border-radius: 6px; padding: 5px; width: 50px '><img src='images/delete_icon.PNG' style='height: 20px; width: 20px'></a>
       </li>";
          $questionCounter++; 
        }
