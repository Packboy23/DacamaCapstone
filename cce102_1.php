...
<div style="margin-top: 115px; margin-left: 170px"><br>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $query = "SELECT fullname, year, cc102_1, cc102_2 FROM tbl_users WHERE (cc102_1 IS NOT NULL AND cc102_1 < $selectedScore and role_id = 2 and year = 1) or (cc102_2 IS NOT NULL AND cc102_2 < $selectedScore AND year = 1 and role_id = 2) ";
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                echo "<tr>
                        <td>{$row['fullname']}</td>
                        <td style='width: 120px'><center>{$row['cc102_1']}</center></td>
                        <td style='width: 120px'><center>{$row['cc102_2']}</center></td>
                      </tr>";
            }
