...
<div class="page-content">
    <div class="card">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO tbl_yearly (user_id, fullname, score) VALUES ('$user_id', '$fullname', '$score')";

            if ($conn->query($sql) === TRUE) {

                $updateSql = "UPDATE tbl_yearly
                JOIN tbl_users ON tbl_yearly.user_id = tbl_users.user_id
                SET tbl_yearly.fullname = tbl_users.fullname";
