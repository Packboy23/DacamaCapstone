...
<h1 style="text-shadow: 1px 1px 1px #000000; color: #1d7874; font-size: 20px">&nbsp&nbsp&nbspTeacher's List</h1>
...
if (isset($_SESSION['user_id'])) {
    ...
    $sql = "SELECT * FROM tbl_users WHERE role_id = 1";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<table border='1'>";
        echo "<tr><th style='height: 40px; background-color: #34425A; color: white;'>&nbsp&nbsp&nbsp&nbspName &nbsp&nbsp&nbsp&nbsp</th>
        <th style='background-color: #34425A; color: white;'>&nbsp&nbspID Number&nbsp&nbsp </th>
        <th style='background-color: #34425A; color: white;'>&nbsp&nbsp Course&nbsp&nbsp </th>
        ...
        <th style='background-color: #34425A; color: white; width: 200px'>&nbsp&nbsp&nbsp Address&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
        <th style='background-color: #34425A; color: white; width: 400px'> Birthday</th>
