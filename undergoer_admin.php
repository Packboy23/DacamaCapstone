...
if ($result->num_rows > 0) {
    ...
    echo "<table border='1'>";
    echo "<tr><th style='height: 50px; background-color: #34425A;color: white'>&nbsp&nbsp&nbsp&nbspFullName &nbsp&nbsp&nbsp&nbsp</th>
    <th style='background-color: #34425A;color: white'>&nbsp &nbsp&nbsp&nbspStudent ID &nbsp&nbsp&nbsp&nbsp</th>
    <th style='background-color: #34425A;color: white'> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspCourse&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
    <th style='background-color: #34425A;color: white'> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspCourse&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
    <th style='background-color: #34425A;color: white'>&nbsp&nbsp&nbsp Day&nbsp&nbsp&nbsp </th>
    <th style='background-color: #34425A;color: white'> Time </th></tr>";
