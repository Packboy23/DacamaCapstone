...
<div style="margin-top: -10px; margin-left: 40px; position: ">
            ...
            if (isset($_SESSION['user_id'])) {
                ...
                $sql = "SELECT * FROM tbl_users WHERE exam_score and exam_score2 IS NOT NULL AND year IN (1)  ORDER BY fullname ASC";
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr><td style='color: #34425A'>"
                            ...
                            . $row["exam_score"] . "%&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                            &nbsp<td style='color: black'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"    
                            . $row["exam_score2"] . "%&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                            
                            
                            <td style='width: 70px'><a href='edit_student.php?id=" . $row['user_id'] . "'><center><img src='images/edit_icon.PNG' style='height: 20px; width: 20px'></center></a></td>
                            <td style='width: 90px'><a href='delete_student.php?id=" . $row['user_id'] . "'><center><img src='images/delete_gif.gif' style='height: 20px; width: 20px'></center></a></td>
